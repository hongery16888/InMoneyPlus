        ...
        if (isLine) {
            ...
            if (status == Status.MA) {
                ...
                if (lastPoint.getMA3Price() != 0) {
                    view.drawMainLine(canvas, ma30Paint, lastX, lastPoint.getMA3Price(), curX, curPoint.getMA3Price());
                }
                //画ma5
...
//                //画ma8
//                if (lastPoint.getMA8Price() != 0) {
//                    view.drawMainLine(canvas, ma10Paint, lastX, lastPoint.getMA8Price(), curX, curPoint.getMA8Price());
//                }
                //画ma10
...
//                //画ma13
//                if (lastPoint.getMA13Price() != 0) {
//                    view.drawMainLine(canvas, ma30Paint, lastX, lastPoint.getMA13Price(), curX, curPoint.getMA13Price());
//                }
//                //画ma30
...
//                if (point.getMA8Price() != 0) {
//                    text = "MA8:" + view.formatValue(point.getMA8Price()) + "  ";
//                    canvas.drawText(text, x, y, ma10Paint);
//                    x += ma10Paint.measureText(text);
//                }
//                if (point.getMA13Price() != 0) {
//                    text = "MA13:" + view.formatValue(point.getMA13Price());
//                    canvas.drawText(text, x, y, ma30Paint);
//                }
            } else if (status == Status.BOLL) {
                if (point.getMb() != 0) {
