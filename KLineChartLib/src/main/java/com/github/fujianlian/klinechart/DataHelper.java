...
public class DataHelper {
    ...
    static void calculateMA(List<KLineEntity> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            ma60 += closePrice;
            if (i == 2) {
                point.MA5Price = ma3 / 3f;
            } else if (i >= 3) {
                ma3 -= dataList.get(i - 3).getClosePrice();
                point.MA3Price = ma3 / 3f;
            } else {
                point.MA3Price = 0f;
            }
            if (i == 4) {
            ...
            if (i == 7) {
                ...
                ma8 -= dataList.get(i - 8).getClosePrice();
                point.MA8Price = ma8 / 8f;
            } else {
                point.MA8Price = 0f;
            }
            ...
            if (i == 12) {
                point.MA13Price = ma13 / 13f;
            } else if (i >= 13) {
                ma13 -= dataList.get(i - 13).getClosePrice();
                point.MA13Price = ma13 / 13f;
            } else {
                point.MA13Price = 0f;
            }
            ...
            if (i == 20) {
                point.MA21Price = ma21 / 21f;
            } else if (i >= 21) {
                ma21 -= dataList.get(i - 21).getClosePrice();
                point.MA21Price = ma21 / 21f;
            } else {
                point.MA21Price = 0f;
            }
