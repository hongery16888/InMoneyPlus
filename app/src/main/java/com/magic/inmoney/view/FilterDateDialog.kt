...
import com.magic.inmoney.databinding.FilterDateDialogBinding
...
open class FilterDateDialog : Dialog {

    private val selectedDates = mutableSetOf<LocalDate>()
    private val today = LocalDate.now()
    private val monthTitleFormatter = DateTimeFormatter.ofPattern("MMMM")
    private var binding: FilterDateDialogBinding
    ...
    constructor(context: Context, themeResId: Int) : super(context, R.style.dialog) {
        val view = inflate(context, R.layout.filter_date_dialog, null)
        setContentView(view)
    ...
    fun setSelectDateListener(selectListener: OnDateSelectListener?): FilterDateDialog{
